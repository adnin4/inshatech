...
export async function onRequestPost({ request, env = {} }) {
    try {
        ...
        const postData = new URLSearchParams({
            ...
            currency: 'BDT',
            tran_id: orderId,
            success_url: `https://inshatech.pages.dev/api/payments/return?provider=sslcommerz&status=success&order_id=${orderId}`,
            fail_url: `https://inshatech.pages.dev/api/payments/return?provider=sslcommerz&status=failed&order_id=${orderId}`,
            cancel_url: `https://inshatech.pages.dev/api/payments/return?provider=sslcommerz&status=cancelled&order_id=${orderId}`,
