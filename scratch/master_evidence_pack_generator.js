...
console.log('================================================================================');
console.log('ðŸ‘‘ IINSHA AI-BOS â€” MASTER PRODUCTION EVIDENCE GENERATION SUITE');
console.log('================================================================================\n');
...
console.log(`ðŸ“Œ Target Git Commit SHA: ${gitSha}`);
console.log(`ðŸ“Œ Master Evidence Timestamp: ${buildTime}\n`);
...
function logEvidence(phaseNum, phaseName, testName, passed, detail) {
    if (passed) {
        totalPassed++;
        console.log(`âœ… [PHASE ${String(phaseNum).padStart(2, '0')}] ${phaseName} -> ${testName}`);
        ...
        totalFailed++;
        console.log(`âŒ [PHASE ${String(phaseNum).padStart(2, '0')}] ${phaseName} -> ${testName}`);
        console.log(`   âš ï¸ Failure Detail: ${detail}`);
        evidenceLog.push({
            phase: phaseNum,
            phase_name: phaseName,
            test: testName,
...
async function generateMasterEvidencePack() {
    ...
    let mdReport = `# ðŸ‘‘ IINSHA AI-BOS â€” MASTER PRODUCTION EVIDENCE REPORT\n\n`;
    ...
    mdReport += `## ðŸ“Š Executive Verification Summary\n\n`;
    ...
    mdReport += `## ðŸ›¡ï¸ Verifiable Evidence Log\n\n`;
    mdReport += `| Phase | Capability | Test Verification | Status | Evidence Detail |\n`;
    mdReport += `| :---: | :--- | :--- | :---: | :--- |\n`;
    evidenceLog.forEach(e => {
        mdReport += `| **${e.phase}** | ${e.phase_name} | ${e.test} | ${e.status === 'PASS' ? 'âœ… PASS' : 'âŒ FAIL'} | ${e.evidence} |\n`;
    });
    ...
    console.log('\n================================================================================');
    console.log(`ðŸ† MASTER EVIDENCE REPORT GENERATED: ${totalPassed} PASSED / ${totalFailed} FAILED`);
    console.log(`ðŸ“‚ Evidence Artifact: ${jsonPath}`);
