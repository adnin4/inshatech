...
Write-Output "================================================================================"
Write-Output "👑 UPDATING FINAL MASTER ARCHIVE (LEMON SQUEEZY E2E RECONCILIATION VERIFIED): $zipPath"
Write-Output "================================================================================"
...
$stagingDir = "$env:TEMP\iinsha_complete_staging_e2e_reconciliation"
...
$itemsToCopy = @(
    ...
    "ai_brain", "functions", "knowledge", "src", "supabase", "docs", "scratch", "scripts", ".github", ".env"
)
