...
$localZipMaster = "C:\Users\mahin khan\.gemini\antigravity\scratch\portfolio-showcase\IINSHA_FOUNDATION_GATE_CERTIFIED.zip"

Compress-Archive -Path "$docsDir\*" -DestinationPath $localZipMaster -Force
Copy-Item -Path $localZipMaster -Destination "$targetDir\IINSHA_FOUNDATION_GATE_CERTIFIED.zip" -Force
