...
Write-Output "================================================================================"
Write-Output "👑 UPDATING COMPLETE MASTER ARCHIVE WITH ALL IMPLEMENTATION REPORTS: $zipPath"
Write-Output "================================================================================"

# 1. Update Markdown Reports in subfolder and root of archive folder
...
# Also copy top-level master report to root of archive folder for instant viewing
Copy-Item -Path "$sourceDir\docs\IINSHA_COMPLETE_IMPLEMENTATION_MASTER_REPORT.md" -Destination $folderPath -Force

# 2. Update Complete Workspace Master Zip inside
$stagingDir = "$env:TEMP\iinsha_complete_staging_all_reports_v10"
