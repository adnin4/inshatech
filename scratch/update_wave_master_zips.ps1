...
Write-Output "================================================================================"
Write-Output "👑 UPDATING MASTER WORKSPACE & insha zip all documentes 1.zip"
Write-Output "================================================================================"

# 1. Update markdown reports inside insha zip all documentes 1
...
# 2. Update Master ZIP package inside insha zip all documentes 1
$stagingDir = "$env:TEMP\iinsha_complete_staging_wave"
...
# 3. Compress insha zip all documentes 1 into master zip
