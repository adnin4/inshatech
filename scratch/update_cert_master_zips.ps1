...
$localZipMaster = "C:\Users\mahin khan\.gemini\antigravity\scratch\portfolio-showcase\IINSHA_FINAL_PRODUCTION_CERTIFICATION_MASTER.zip"

Compress-Archive -Path "$docsDir\*" -DestinationPath $localZipMaster -Force
Copy-Item -Path $localZipMaster -Destination "$targetDir\IINSHA_FINAL_PRODUCTION_CERTIFICATION_MASTER.zip" -Force
